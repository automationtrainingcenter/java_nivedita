...
public class Operators {
	/*
	 * There are mainly 5 types of operators in Java 1. Arithmetic operators 
	 * + adds two operands 
	 * - subtracts left operand with right operand 
	 * * multiplies two operands 
	 * / divides left operand with right operand and gives quotient 
	...
	/*
	 * 2. Logical operators 
	 * && (AND) returns true if both the operands are true else
	 * returns false 
	 * || (OR) returns false if both the operands are false else
	 * return true 
	 * ! (NOT) return true if given operand is false
	 */
	public void logical() {
	 ...
	 * == (equals to) returns true if both the operands are equal else returns false 
	 * != (not equal to) returns true if
	 * both the operands are not equal else returns false 
	 * > returns true if left
	 * operand is greater than right operand else false 
	 * < returns true if left
	 * operand is less than right operand else false 
	 * >= returns true if left operand
	 * is greater than or equal to right operand else false 
	 * <= returns true if left
	 * operand is less than or equal to right operand else false 
	 * instanceOf() returns true if given object is instance of a given class else return false
	 */
	 ...
	 * += add left operand with right operand and assign value to left operand 
	 * -+ subtracts left operand with right operand and assign value to left operand 
	 * *= multiplies left operand with right operand and assign value to left operand
	 * /= divides left operand with right operand and assign quotient to left operand 
	 * %= divides left operand with right operand and assign reminder to left operand 
